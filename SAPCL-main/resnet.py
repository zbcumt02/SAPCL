...
from nnetwork.rgcn import RGCN
from nnetwork.srl_gcn import SrlGcn
import  nnetwork.abstract_gnn
...
class SupConResNet(nn.Module):
    ...
    def forward(self, x):
        # if self.encoder == RGCN or self.encoder == SrlGcn:
        #     feat = self.encoder(x, 256, 4)
        # else:
        feat = self.encoder(x)
