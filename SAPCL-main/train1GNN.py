...
for treeLSTM -- gnnsupconwithoutadj -- treeLSTMfornode2--Accuracy is 60.84% (78.49%)(0.15)(0.46)(0.12)(0.20)
...
from gnnsupconwithoutadj import SupConGNN2
from utils.treeLSTMfornode2 import load_phemes
...
parser.add_argument('--dataset', default='wtwt', type=str,
                    choices=['phemes', 'weibo', 'wtwt'])
parser.add_argument('--exp-dir', default='experiment/wtwt', type=str,
                    help='experiment directory for saving checkpoints and logs, '
                         'phemes')
parser.add_argument('-a', '--arch', metavar='ARCH', default='supconGNN2', choices=['supconGNN2'],
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'phemes':
        train_loader, train_givenY, train_sampler, test_loader = load_phemes(partial_rate=args.partial_rate,
