...
for initial -- EBGCN -- model5 -- pheme_trees_edges --Accuracy is 67.40% (90.27%)(0.27)(0.59)(0.24)(0.25)
...
from utils.pheme_trees5 import load_phemes_edges
...
parser.add_argument('--loss_weight', default=0.75, type=float,
...
def train(train_loader, model, arr_index_list, loss_fn, loss_cont_fn,
    ...
    progress = ProgressMeter(
        len(train_loader),
        [batch_time, data_time, acc_cls, acc_proto, loss_cls_log, loss_cont_log, loss_td_log, loss_bu_log],
    ...
    for batch_data in train_loader:
        ...
        (cls_out, features_cont, pseudo_target_cont, score_prot,
         TD_edge_loss, BU_edge_loss) = model(X_w, X_s, Y, td_edge, bu_edge, batch, ptr, args)
        ...
        loss = (loss_cls + args.loss_weight * loss_cont +
                args.edge_loss_td * TD_edge_loss + args.edge_loss_bu * BU_edge_loss)
