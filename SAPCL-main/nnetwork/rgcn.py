...
from nnetwork.abstract_gnn import AbstractGNN
...
class RGCN(AbstractGNN):
    ...
    def __init__(self,input_dim,output_dim,n_layers,n_relations,inverse_edges=False,separate_relation_types_for_inverse=False):
