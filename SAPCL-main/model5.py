...
class SAPCL(nn.Module):
    ...
    def forward(self, img_w, im_s=None, partial_Y=None, td_edge=None, bu_edge=None, batch=None, ptr=None,
        ...
        with torch.no_grad():  # no gradient
            ...
            im_k, idx_unshuffle = self._batch_shuffle_ddp(im_s)
            _, k, _, _ = self.encoder_k(im_k, td_edge, bu_edge, batch, ptr)
            # undo shuffle
        ...
        return output, features, pseudo_labels, score_prot, TD_edge_loss, BU_edge_loss
